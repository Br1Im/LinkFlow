#!/usr/bin/env python3
"""
Тест создания платежа на 110₽ через админ-панель
"""
...
def test_payment_110():
    """Тестирует создание платежа на 110₽"""
    print("=" * 70)
    print("ТЕСТ: Создание платежа на 110₽")
    print("=" * 70)
