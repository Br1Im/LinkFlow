...
WELCOME_TEXT = os.getenv("WELCOME_TEXT") or (
    "Приветствуем Вас спортсмены!\n\n"
    "В этом курсе Вы узнаете что такое спорт и здоровое тело📸\n\n"
...
# -------------- Tribute --------------
def _parse_tribute_links(raw: str) -> Optional[Dict[int, str]]:
    """
    Ждём формат в .env:
