...
async def _save_about(text: str | None = None, photo: str | None = None):
    if text is not None:
        await run_db_query(
...
async def _preview_photo(bot, chat_id: int, photo: str, caption: str | None = None) -> bool:
    """
...
def setup_admin_handlers(dp: Dispatcher, bot):
    ...
    async def _render_payments_panel(chat_id: int, message: types.Message | None = None):
