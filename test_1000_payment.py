#!/usr/bin/env python3
"""
Тест создания платежа на 1000₽ через админ-панель
"""
...
def test_payment_1000():
    """Тестирует создание платежа на 1000₽"""
    print("=" * 70)
    print("ТЕСТ: Создание платежа на 1000₽")
    print("=" * 70)
    ...
    try:
        ...
        print(f"\n⏱️  ТАЙМАУТ! Запрос превысил 120 секунд")
        return False
