...
def setup_public_handlers(dp: Dispatcher, bot):
    ...
    async def process_about_channel(callback: types.CallbackQuery, state: FSMContext):
        ...
        agreement_text = (
            ...
            "1.2. Сервис – Telegram-бот @crypto_vip_robot, принадлежащий Исполнителю и предназначенный для продажи Товара.\n"
            ...
            "2.2. Сервис @crypto_vip_robot является независимой площадкой и не является аффилированным лицом Telegram FZ-LLC.\n\n"
            "3. Порядок оплаты\n"
            ...
            "Полная версия: https://telegra.ph/User-Agreement-Crypto-VIP-Bot"
        )
